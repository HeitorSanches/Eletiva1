...
<html lang="en">
  ...
  <form method="post" action="exer1resposta.php">
                        ...
                        <div class="mb-3">
                            <label for="valor3" class="form-label">Informe o primeiro valor :</label>
                            <input type="number" id="valor3" name="valor3" class="form-control" required="">
                        </div>
                    
                        <div class="mb-3">
                            <label for="valor4" class="form-label">Informe o segundo valor:</label>
                        ...
                        <div class="mb-3">
                            <label for="valor5" class="form-label">Informe o primeiro valor :</label>
                            <input type="number" id="valor5" name="valor5" class="form-control" required="">
                        </div>
                    
                        <div class="mb-3">
                            <label for="valor6" class="form-label">Informe o segundo valor:</label>
                        ...
                        <div class="mb-3">
                            <label for="valor7" class="form-label">Informe o primeiro valor :</label>
